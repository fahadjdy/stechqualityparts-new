<x-app-layout>
    <section class="pt-32 pb-16 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h1 class="section-title mt-4">All <span class="highlight">Products</span></h1>
            <p class="text-slate-500 mt-3 max-w-lg">Browse our complete range of premium quality Bolero spare parts.</p>
        </div>
    </section>
    ...
    @push('styles')
    <style>
        /* Pagination styling (Blue) */
        nav[role="navigation"] div { display: flex; align-items: center; gap: 0.5rem; flex-wrap: wrap; justify-content: center; }
        nav[role="navigation"] span[aria-current="page"] span {
            background: var(--accent-gradient); color: white; border-radius: 0.5rem; padding: 0.5rem 1rem;
            font-weight: 700; font-size: 0.875rem;
        }
        nav[role="navigation"] a {
            background: white; color: #475569; border: 1px solid rgba(0,0,0,0.06); border-radius: 0.5rem;
            padding: 0.5rem 1rem; font-weight: 600; font-size: 0.875rem; transition: all 0.3s;
        }
